...
VL_MODULE(Vtb) {
  public:
    ...
    VL_SIG16(tb__DOT__top__DOT__j1_prb__DOT__dstack__DOT__head,15,0);
    VL_SIG16(tb__DOT__top__DOT__j1_prb__DOT__rstack__DOT__head,15,0);
    ...
    VL_SIGW(tb__DOT__top__DOT__j1_prb__DOT__dstack__DOT__tail,239,0,8);
    VL_SIGW(tb__DOT__top__DOT__j1_prb__DOT__dstack__DOT__tailN,239,0,8);
    VL_SIG(tb__DOT__top__DOT__j1_prb__DOT__dstack__DOT__depth,31,0);
    VL_SIGW(tb__DOT__top__DOT__j1_prb__DOT__rstack__DOT__tail,271,0,9);
    VL_SIGW(tb__DOT__top__DOT__j1_prb__DOT__rstack__DOT__tailN,271,0,9);
    VL_SIG(tb__DOT__top__DOT__j1_prb__DOT__rstack__DOT__depth,31,0);
  ...
  public:
    static void _combo__TOP__9(Vtb__Syms* __restrict vlSymsp);
  private:
  ...
  public:
    ...
    static void traceChgThis__15(Vtb__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code);
